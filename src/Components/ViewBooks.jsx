...
import { deleteAllBooks, deleteBook, fetchBooks } from "../Store/BookSlice";
                ...
                <>
                    {data.map((newBook) => (
                        <div className='book' key={newBook.id}>
                            ...
                            {/* Display the image if there is an imageUrl */}
                            {newBook.book.imageUrl && (
                                <div className='image'>
                                    <img src={newBook.book.imageUrl} alt='Book Cover' className="book-image" />
                                </div>
                            )}
